...
const TrafficWidget = ({divId}) => {
    ...
    let busLines = [
      ...
      var greenbus = busLines.filter((busLine) => ['4', '7', '10','223'].includes(busLine.line));
      ...
      const [lineType, setLineType] = useState(greenbus);
            ...
            useEffect(() => {
                 ...
                 const interval = setInterval(() => {
                    ...
                    const color = colorChange === 'bg-green-500' ? 'bg-yellow-500' : 'bg-green-500';
                        ...
                        {busLines.map((busLine, index) => (
                            ...
                            >
                                <td className="text-white">
                                    <div className={BussColor + ' w-[70%] text-right pr-3 rounded-r-xl'}>
                                        {busLine.line}
                                    </div>
                                </td>
